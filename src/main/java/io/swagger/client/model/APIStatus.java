...
public class APIStatus {
  ...
  **/
  @Schema(required = true, description = "Year of the current FRC season.")
   ...
   * @return maxSeason
  **/
  @Schema(required = true, description = "Maximum FRC season year for valid queries.")
  ...
  **/
  @Schema(required = true, description = "True if the entire FMS API provided by FIRST is down.")
  public Boolean isIsDatafeedDown() {
    return isDatafeedDown;
  }
   ...
   * @return downEvents
  **/
  @Schema(required = true, description = "An array of strings containing event keys of any active events that are no longer updating.")
