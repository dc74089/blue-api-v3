...
import io.swagger.client.model.EventRankingExtraStatsInfo;
...
public class EventRanking {
   ...
   * @return rankings
  **/
  @Schema(required = true, description = "List of rankings at the event.")
  ...
  **/
  @Schema(description = "List of special TBA-generated values provided in the `extra_stats` array for each item.")
  ...
  **/
  @Schema(required = true, description = "List of year-specific values provided in the `sort_orders` array for each team.")
