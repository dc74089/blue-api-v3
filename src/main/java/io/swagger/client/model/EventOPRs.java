 ...
 */
@Schema(description = "OPR, DPR, and CCWM for teams at the event.")
...
public class EventOPRs {
   ...
   * @return oprs
  **/
  @Schema(description = "A key-value pair with team key (eg `frc254`) as key and OPR as value.")
   ...
   * @return dprs
  **/
  @Schema(description = "A key-value pair with team key (eg `frc254`) as key and DPR as value.")
   ...
   * @return ccwms
  **/
  @Schema(description = "A key-value pair with team key (eg `frc254`) as key and CCWM as value.")
