...
public class APIStatusAppVersion {
  ...
  **/
  @Schema(required = true, description = "Internal use - Minimum application version required to correctly connect and process data.")
  ...
  **/
  @Schema(required = true, description = "Internal use - Latest application version available.")
