...
public class DistrictList {
   ...
   * @return abbreviation
  **/
  @Schema(required = true, description = "The short identifier for the district.")
   ...
   * @return displayName
  **/
  @Schema(required = true, description = "The long name for the district.")
   ...
   * @return key
  **/
  @Schema(required = true, description = "Key for this district, e.g. `2016ne`.")
   ...
   * @return year
  **/
  @Schema(required = true, description = "Year this district participated.")
