...
public class Webcast {
   ...
   * @return type
  **/
  @Schema(required = true, description = "Type of webcast, typically descriptive of the streaming provider.")
   ...
   * @return channel
  **/
  @Schema(required = true, description = "Type specific channel information. May be the YouTube stream, or Twitch channel name. In the case of iframe types, contains HTML to embed the stream in an HTML iframe.")
   ...
   * @return file
  **/
  @Schema(description = "File identification as may be required for some types. May be null.")
