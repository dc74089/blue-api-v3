...
public class MatchAlliance {
   ...
   * @return score
  **/
  @Schema(required = true, description = "Score for this alliance. Will be null or -1 for an unplayed match.")
  ...
  **/
  @Schema(description = "TBA team keys (eg `frc254`) of any teams playing as a surrogate.")
   ...
   * @return dqTeamKeys
  **/
  @Schema(description = "TBA team keys (eg `frc254`) of any disqualified teams.")
