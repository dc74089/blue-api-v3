 ...
 */
@Schema(description = "Timeseries data for the 2018 game *FIRST* POWER UP. *WARNING:* This is *not* official data, and is subject to a significant possibility of error, or missing data. Do not rely on this data for any purpose. In fact, pretend we made it up. *WARNING:* This model is currently under active development and may change at any time, including in breaking ways.")
...
public class MatchTimeseries2018 {
   ...
   * @return eventKey
  **/
  @Schema(description = "TBA event key with the format yyyy[EVENT_CODE], where yyyy is the year, and EVENT_CODE is the event code of the event.")
   ...
   * @return matchId
  **/
  @Schema(description = "Match ID consisting of the level, match number, and set number, eg `qm45` or `f1m1`.")
   ...
   * @return mode
  **/
  @Schema(description = "Current mode of play, can be `pre_match`, `auto`, `telop`, or `post_match`.")
  ...
  **/
  @Schema(description = "Amount of time remaining in the match, only valid during `auto` and `teleop` modes.")
  ...
  **/
  @Schema(description = "1 if the blue alliance is credited with the AUTO QUEST, 0 if not.")
  ...
  **/
  @Schema(description = "Number of POWER CUBES in the BOOST section of the blue alliance VAULT.")
  ...
  **/
  @Schema(description = "Returns 1 if the blue alliance BOOST was played, or 0 if not played.")
  ...
  **/
  @Schema(description = "Name of the current blue alliance POWER UP being played, or `null`.")
  ...
  **/
  @Schema(description = "1 if the blue alliance is credited with FACING THE BOSS, 0 if not.")
  ...
  **/
  @Schema(description = "Number of POWER CUBES in the FORCE section of the blue alliance VAULT.")
  ...
  **/
  @Schema(description = "Returns 1 if the blue alliance FORCE was played, or 0 if not played.")
  ...
  **/
  @Schema(description = "Number of POWER CUBES in the LEVITATE section of the blue alliance VAULT.")
  ...
  **/
  @Schema(description = "Returns 1 if the blue alliance LEVITATE was played, or 0 if not played.")
  ...
  **/
  @Schema(description = "Number of seconds remaining in the blue alliance POWER UP time, or 0 if none is active.")
  ...
  **/
  @Schema(description = "1 if the blue alliance owns the SCALE, 0 if not.")
   ...
   * @return blueScore
  **/
  @Schema(description = "Current score for the blue alliance.")
  ...
  **/
  @Schema(description = "1 if the blue alliance owns their SWITCH, 0 if not.")
   ...
   * @return redAutoQuest
  **/
  @Schema(description = "1 if the red alliance is credited with the AUTO QUEST, 0 if not.")
  ...
  **/
  @Schema(description = "Number of POWER CUBES in the BOOST section of the red alliance VAULT.")
  ...
  **/
  @Schema(description = "Returns 1 if the red alliance BOOST was played, or 0 if not played.")
  ...
  **/
  @Schema(description = "Name of the current red alliance POWER UP being played, or `null`.")
  ...
  **/
  @Schema(description = "1 if the red alliance is credited with FACING THE BOSS, 0 if not.")
  ...
  **/
  @Schema(description = "Number of POWER CUBES in the FORCE section of the red alliance VAULT.")
  ...
  **/
  @Schema(description = "Returns 1 if the red alliance FORCE was played, or 0 if not played.")
  ...
  **/
  @Schema(description = "Number of POWER CUBES in the LEVITATE section of the red alliance VAULT.")
  ...
  **/
  @Schema(description = "Returns 1 if the red alliance LEVITATE was played, or 0 if not played.")
  ...
  **/
  @Schema(description = "Number of seconds remaining in the red alliance POWER UP time, or 0 if none is active.")
  ...
  **/
  @Schema(description = "1 if the red alliance owns the SCALE, 0 if not.")
   ...
   * @return redScore
  **/
  @Schema(description = "Current score for the red alliance.")
  ...
  **/
  @Schema(description = "1 if the red alliance owns their SWITCH, 0 if not.")
