...
public class TeamEventStatusRankRanking {
  ...
  **/
   ...
   * @return qualAverage
  **/
  @Schema(description = "For some years, average qualification score. Can be null.")
   ...
   * @return sortOrders
  **/
  @Schema(description = "Ordered list of values used to determine the rank. See the `sort_order_info` property for the name of each value.")
  ...
  **/
   ...
   * @return rank
  **/
  @Schema(description = "Relative rank of this team.")
   ...
   * @return dq
  **/
  @Schema(description = "Number of matches the team was disqualified for.")
   ...
   * @return teamKey
  **/
  @Schema(description = "TBA team key for this rank.")
