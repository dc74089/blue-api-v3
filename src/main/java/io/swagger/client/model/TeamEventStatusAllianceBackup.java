 ...
 */
@Schema(description = "Backup status, may be null.")
...
public class TeamEventStatusAllianceBackup {
   ...
   * @return out
  **/
  @Schema(description = "TBA key for the team replaced by the backup.")
   ...
   * @return in
  **/
  @Schema(description = "TBA key for the backup team called in.")
  public String getIn() {
    return in;
  }
