 ...
 */
@Schema(description = "Insights for FIRST Stronghold qualification and elimination matches.")
...
public class EventInsights2016 {
   ...
   * @return lowBar
  **/
  @Schema(required = true, description = "For the Low Bar - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
  ...
  **/
  @Schema(required = true, description = "For the Cheval De Frise - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
   ...
   * @return aPortcullis
  **/
  @Schema(required = true, description = "For the Portcullis - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
   ...
   * @return bRamparts
  **/
  @Schema(required = true, description = "For the Ramparts - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
   ...
   * @return bMoat
  **/
  @Schema(required = true, description = "For the Moat - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
   ...
   * @return cSallyPort
  **/
  @Schema(required = true, description = "For the Sally Port - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
   ...
   * @return cDrawbridge
  **/
  @Schema(required = true, description = "For the Drawbridge - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
  ...
  **/
  @Schema(required = true, description = "For the Rough Terrain - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
   ...
   * @return dRockWall
  **/
  @Schema(required = true, description = "For the Rock Wall - An array with three values, number of times damaged, number of opportunities to damage, and percentage.")
  ...
  **/
  @Schema(required = true, description = "Average number of high goals scored.")
  ...
  **/
  @Schema(required = true, description = "Average number of low goals scored.")
   ...
   * @return breaches
  **/
  @Schema(required = true, description = "An array with three values, number of times breached, number of opportunities to breach, and percentage.")
   ...
   * @return scales
  **/
  @Schema(required = true, description = "An array with three values, number of times scaled, number of opportunities to scale, and percentage.")
   ...
   * @return challenges
  **/
  @Schema(required = true, description = "An array with three values, number of times challenged, number of opportunities to challenge, and percentage.")
   ...
   * @return captures
  **/
  @Schema(required = true, description = "An array with three values, number of times captured, number of opportunities to capture, and percentage.")
  ...
  **/
   ...
   * @return averageScore
  **/
  @Schema(required = true, description = "Average total score.")
  ...
  **/
  @Schema(required = true, description = "Average autonomous score.")
  ...
  **/
  @Schema(required = true, description = "Average crossing score.")
  ...
  **/
  @Schema(required = true, description = "Average boulder score.")
  ...
  **/
  @Schema(required = true, description = "Average tower score.")
