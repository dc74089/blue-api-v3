...
public class TeamRobot {
   ...
   * @return year
  **/
  @Schema(required = true, description = "Year this robot competed in.")
   ...
   * @return robotName
  **/
  @Schema(required = true, description = "Name of the robot as provided by the team.")
   ...
   * @return key
  **/
  @Schema(required = true, description = "Internal TBA identifier for this robot.")
   ...
   * @return teamKey
  **/
  @Schema(required = true, description = "TBA team key for this robot.")
