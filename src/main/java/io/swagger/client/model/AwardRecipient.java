...
public class AwardRecipient {
   ...
   * @return teamKey
  **/
  @Schema(description = "The TBA team key for the team that was given the award. May be null.")
   ...
   * @return awardee
  **/
  @Schema(description = "The name of the individual given the award. May be null.")
