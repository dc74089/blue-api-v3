...
public class EventDistrictPoints {
   ...
   * @return points
  **/
  @Schema(required = true, description = "Points gained for each team at the event. Stored as a key-value pair with the team key as the key, and an object describing the points as its value.")
   ...
   * @return tiebreakers
  **/
  @Schema(description = "Tiebreaker values for each team at the event. Stored as a key-value pair with the team key as the key, and an object describing the tiebreaker elements as its value.")
