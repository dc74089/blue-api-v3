...
public class TeamEventStatusPlayoff {
   ...
   * @return level
  **/
  @Schema(description = "The highest playoff level the team reached.")
  ...
  **/
   ...
   * @return status
  **/
  @Schema(description = "Current competition status for the playoffs.")
  ...
  **/
  @Schema(description = "The average match score during playoffs. Year specific. May be null if not relevant for a given year.")
