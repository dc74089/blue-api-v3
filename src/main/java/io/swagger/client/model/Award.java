...
public class Award {
   ...
   * @return name
  **/
  @Schema(required = true, description = "The name of the award as provided by FIRST. May vary for the same award type.")
   ...
   * @return awardType
  **/
  @Schema(required = true, description = "Type of award given. See https://github.com/the-blue-alliance/the-blue-alliance/blob/master/consts/award_type.py#L6")
   ...
   * @return eventKey
  **/
  @Schema(required = true, description = "The event_key of the event the award was won at.")
  ...
  **/
  @Schema(required = true, description = "A list of recipients of the award at the event. May have either a team_key or an awardee, both, or neither (in the case the award wasn't awarded at the event).")
   ...
   * @return year
  **/
  @Schema(required = true, description = "The year this award was won.")
