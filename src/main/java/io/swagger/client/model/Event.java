...
public class Event {
   ...
   * @return key
  **/
  @Schema(required = true, description = "TBA event key with the format yyyy[EVENT_CODE], where yyyy is the year, and EVENT_CODE is the event code of the event.")
   ...
   * @return name
  **/
  @Schema(required = true, description = "Official name of event on record either provided by FIRST or organizers of offseason event.")
   ...
   * @return eventCode
  **/
  @Schema(required = true, description = "Event short code, as provided by FIRST.")
   ...
   * @return eventType
  **/
  @Schema(required = true, description = "Event Type, as defined here: https://github.com/the-blue-alliance/the-blue-alliance/blob/master/consts/event_type.py#L2")
  ...
  **/
   ...
   * @return city
  **/
  @Schema(description = "City, town, village, etc. the event is located in.")
   ...
   * @return stateProv
  **/
  @Schema(description = "State or Province the event is located in.")
   ...
   * @return country
  **/
  @Schema(description = "Country the event is located in.")
   ...
   * @return startDate
  **/
  @Schema(required = true, description = "Event start date in `yyyy-mm-dd` format.")
   ...
   * @return endDate
  **/
  @Schema(required = true, description = "Event end date in `yyyy-mm-dd` format.")
   ...
   * @return year
  **/
  @Schema(required = true, description = "Year the event data is for.")
   ...
   * @return shortName
  **/
  @Schema(description = "Same as `name` but doesn't include event specifiers, such as 'Regional' or 'District'. May be null.")
  ...
  **/
  @Schema(required = true, description = "Event Type, eg Regional, District, or Offseason.")
   ...
   * @return week
  **/
  @Schema(description = "Week of the event relative to the first official season event, zero-indexed. Only valid for Regionals, Districts, and District Championships. Null otherwise. (Eg. A season with a week 0 'preseason' event does not count, and week 1 events will show 0 here. Seasons with a week 0.5 regional event will show week 0 for those event(s) and week 1 for week 1 events and so on.)")
   ...
   * @return address
  **/
  @Schema(description = "Address of the event's venue, if available.")
   ...
   * @return postalCode
  **/
  @Schema(description = "Postal code from the event address.")
   ...
   * @return gmapsPlaceId
  **/
  @Schema(description = "Google Maps Place ID for the event address.")
   ...
   * @return gmapsUrl
  **/
  @Schema(description = "Link to address location on Google Maps.")
   ...
   * @return lat
  **/
  @Schema(description = "Latitude for the event address.")
   ...
   * @return lng
  **/
  @Schema(description = "Longitude for the event address.")
   ...
   * @return locationName
  **/
  @Schema(description = "Name of the location at the address for the event, eg. Blue Alliance High School.")
   ...
   * @return timezone
  **/
  @Schema(description = "Timezone name.")
   ...
   * @return website
  **/
  @Schema(description = "The event's website, if any.")
   ...
   * @return firstEventId
  **/
  @Schema(description = "The FIRST internal Event ID, used to link to the event on the FRC webpage.")
  ...
  **/
  @Schema(description = "Public facing event code used by FIRST (on frc-events.firstinspires.org, for example)")
  ...
  **/
   ...
   * @return divisionKeys
  **/
  @Schema(description = "An array of event keys for the divisions at this event.")
  ...
  **/
  @Schema(description = "The TBA Event key that represents the event's parent. Used to link back to the event from a division event. It is also the inverse relation of `divison_keys`.")
   ...
   * @return playoffType
  **/
  @Schema(description = "Playoff Type, as defined here: https://github.com/the-blue-alliance/the-blue-alliance/blob/master/consts/playoff_type.py#L4, or null.")
  ...
  **/
  @Schema(description = "String representation of the `playoff_type`, or null.")
