...
public class Team {
   ...
   * @return key
  **/
  @Schema(required = true, description = "TBA team key with the format `frcXXXX` with `XXXX` representing the team number.")
   ...
   * @return teamNumber
  **/
  @Schema(required = true, description = "Official team number issued by FIRST.")
  ...
  **/
   ...
   * @return name
  **/
  @Schema(required = true, description = "Official long name registered with FIRST.")
   ...
   * @return schoolName
  **/
  @Schema(description = "Name of team school or affilited group registered with FIRST.")
  ...
  **/
   ...
   * @return address
  **/
  @Schema(description = "Will be NULL, for future development.")
  ...
  **/
   ...
   * @return motto
  **/
  @Schema(description = "Team's motto as provided by FIRST. This field is deprecated and will return null - will be removed at end-of-season in 2019.")
  ...
  **/
  @Schema(description = "Location of the team's home championship each year as a key-value pair. The year (as a string) is the key, and the city is the value.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, teamNumber, nickname, name, schoolName, city, stateProv, country, address, postalCode, gmapsPlaceId, gmapsUrl, lat, lng, locationName, website, rookieYear, motto, homeChampionship);
  }
