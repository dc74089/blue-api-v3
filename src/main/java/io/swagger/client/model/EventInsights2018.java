 ...
 */
@Schema(description = "Insights for FIRST Power Up qualification and elimination matches.")
...
public class EventInsights2018 {
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times auto quest was completed, number of opportunities to complete the auto quest, and percentage.")
  ...
  **/
  @Schema(required = true, description = "Average number of boost power up scored (out of 3).")
  ...
  **/
  @Schema(required = true, description = "Average endgame points.")
  ...
  **/
  @Schema(required = true, description = "Average number of force power up scored (out of 3).")
  ...
  **/
  @Schema(required = true, description = "Average scale ownership points scored.")
  ...
  **/
  @Schema(required = true, description = "Average scale ownership points scored during auto.")
  ...
  **/
  @Schema(required = true, description = "Average scale ownership points scored during teleop.")
  ...
  **/
  @Schema(required = true, description = "Average switch ownership points scored.")
  ...
  **/
  @Schema(required = true, description = "Average switch ownership points scored during auto.")
  ...
  **/
  @Schema(required = true, description = "Average switch ownership points scored during teleop.")
  ...
  **/
  @Schema(required = true, description = "Average value points scored.")
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times a boost power up was played, number of opportunities to play a boost power up, and percentage.")
   ...
   * @return climbCounts
  **/
  @Schema(required = true, description = "An array with three values, number of times a climb occurred, number of opportunities to climb, and percentage.")
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times an alliance faced the boss, number of opportunities to face the boss, and percentage.")
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times a force power up was played, number of opportunities to play a force power up, and percentage.")
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times a levitate power up was played, number of opportunities to play a levitate power up, and percentage.")
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times a team scored mobility points in auto, number of opportunities to score mobility points in auto, and percentage.")
  ...
  **/
  @Schema(required = true, description = "Average scale neutral percentage.")
  ...
  **/
  @Schema(required = true, description = "Average scale neutral percentage during auto.")
  ...
  **/
  @Schema(required = true, description = "Average scale neutral percentage during teleop.")
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times a switch was owned during auto, number of opportunities to own a switch during auto, and percentage.")
  ...
  **/
  @Schema(required = true, description = "An array with three values, number of times a unicorn match (Win + Auto Quest + Face the Boss) occurred, number of opportunities to have a unicorn match, and percentage.")
  ...
  **/
  @Schema(required = true, description = "Average opposing switch denail percentage for the winning alliance during teleop.")
  ...
  **/
  @Schema(required = true, description = "Average own switch ownership percentage for the winning alliance.")
  ...
  **/
  @Schema(required = true, description = "Average own switch ownership percentage for the winning alliance during auto.")
  ...
  **/
  @Schema(required = true, description = "Average own switch ownership percentage for the winning alliance during teleop.")
  ...
  **/
  @Schema(required = true, description = "Average scale ownership percentage for the winning alliance.")
  ...
  **/
  @Schema(required = true, description = "Average scale ownership percentage for the winning alliance during auto.")
  ...
  **/
  @Schema(required = true, description = "Average scale ownership percentage for the winning alliance during teleop.")
