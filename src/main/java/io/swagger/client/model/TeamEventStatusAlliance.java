...
public class TeamEventStatusAlliance {
  ...
  **/
   ...
   * @return number
  **/
  @Schema(required = true, description = "Alliance number.")
  ...
  **/
   ...
   * @return pick
  **/
  @Schema(required = true, description = "Order the team was picked in the alliance from 0-2, with 0 being alliance captain.")
